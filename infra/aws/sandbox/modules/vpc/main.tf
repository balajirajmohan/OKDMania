# ===========================================================================
# VPC module  (spec section 3)
# ===========================================================================
# Initial sandbox: 1 VPC, IGW, public route table, public subnets, default
# route to the IGW. All four EC2 instances live in the public subnets.
#
# Future-proofing (spec section 3 "easily add private subnets later"):
#   - set private_subnet_cidrs to create private subnets + a private route table
#   - set enable_nat_gateway = true to give them egress
# Nothing about the public tier changes when you do that.
# ===========================================================================
