variable "name_prefix" {
  description = "Prefix for security group names, e.g. \"okd-sandbox\"."
  type        = string
  default     = "okd-sandbox"
}
...
variable "enable_nodeport_from_apps" {
  description = "Also allow the NodePort range (30000-32767) from apps_ingress_cidrs."
  type        = bool
  default     = false
}
